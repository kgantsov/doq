...
func (c *dOQClient) GenerateIDs(ctx context.Context, in *GenerateIDsRequest, opts ...grpc.CallOption) (*GenerateIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateIDsResponse)
	err := c.cc.Invoke(ctx, DOQ_GenerateIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDOQServer) GenerateIDs(context.Context, *GenerateIDsRequest) (*GenerateIDsResponse, error) {
...
func _DOQ_GenerateIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DOQServer).GenerateIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DOQ_GenerateIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DOQServer).GenerateIDs(ctx, req.(*GenerateIDsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DOQ_GenerateIDs_Handler,
		},
		{
