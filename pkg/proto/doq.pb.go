...
func (QueueSettings_Strategy) EnumDescriptor() ([]byte, []int) {
	return file_pkg_proto_doq_proto_rawDescGZIP(), []int{2, 0}
}
...
var file_pkg_proto_doq_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_pkg_proto_doq_proto_goTypes = []any{
	(QueueSettings_Strategy)(0),    // 0: queue.QueueSettings.Strategy
	(*GenerateIDsRequest)(nil),     // 1: queue.GenerateIDsRequest
	(*GenerateIDsResponse)(nil),    // 2: queue.GenerateIDsResponse
	(*QueueSettings)(nil),          // 3: queue.QueueSettings
	(*Queue)(nil),                  // 4: queue.Queue
	(*Message)(nil),                // 5: queue.Message
	(*SnapshotItem)(nil),           // 6: queue.SnapshotItem
	(*CreateQueueRequest)(nil),     // 7: queue.CreateQueueRequest
	(*CreateQueueResponse)(nil),    // 8: queue.CreateQueueResponse
	(*DeleteQueueRequest)(nil),     // 9: queue.DeleteQueueRequest
	(*DeleteQueueResponse)(nil),    // 10: queue.DeleteQueueResponse
	(*GetQueueRequest)(nil),        // 11: queue.GetQueueRequest
	(*Stats)(nil),                  // 12: queue.Stats
	(*GetQueueResponse)(nil),       // 13: queue.GetQueueResponse
	(*GetQueuesRequest)(nil),       // 14: queue.GetQueuesRequest
	(*GetQueuesResponse)(nil),      // 15: queue.GetQueuesResponse
	(*EnqueueRequest)(nil),         // 16: queue.EnqueueRequest
	(*EnqueueResponse)(nil),        // 17: queue.EnqueueResponse
	(*DequeueRequest)(nil),         // 18: queue.DequeueRequest
	(*DequeueResponse)(nil),        // 19: queue.DequeueResponse
	(*GetRequest)(nil),             // 20: queue.GetRequest
	(*GetResponse)(nil),            // 21: queue.GetResponse
	(*DeleteRequest)(nil),          // 22: queue.DeleteRequest
	(*DeleteResponse)(nil),         // 23: queue.DeleteResponse
	(*AckRequest)(nil),             // 24: queue.AckRequest
	(*AckResponse)(nil),            // 25: queue.AckResponse
	(*NackRequest)(nil),            // 26: queue.NackRequest
	(*NackResponse)(nil),           // 27: queue.NackResponse
	(*UpdatePriorityRequest)(nil),  // 28: queue.UpdatePriorityRequest
	(*UpdatePriorityResponse)(nil), // 29: queue.UpdatePriorityResponse
	(*RaftCommand)(nil),            // 30: queue.RaftCommand
	nil,                            // 31: queue.Message.MetadataEntry
	nil,                            // 32: queue.EnqueueRequest.MetadataEntry
	nil,                            // 33: queue.EnqueueResponse.MetadataEntry
	nil,                            // 34: queue.DequeueResponse.MetadataEntry
	nil,                            // 35: queue.GetResponse.MetadataEntry
	nil,                            // 36: queue.NackRequest.MetadataEntry
}
var file_pkg_proto_doq_proto_depIdxs = []int32{
	0,  // 0: queue.QueueSettings.strategy:type_name -> queue.QueueSettings.Strategy
	3,  // 1: queue.Queue.settings:type_name -> queue.QueueSettings
	31, // 2: queue.Message.metadata:type_name -> queue.Message.MetadataEntry
	4,  // 3: queue.SnapshotItem.queue:type_name -> queue.Queue
	5,  // 4: queue.SnapshotItem.message:type_name -> queue.Message
	3,  // 5: queue.CreateQueueRequest.settings:type_name -> queue.QueueSettings
	3,  // 6: queue.GetQueueResponse.settings:type_name -> queue.QueueSettings
	12, // 7: queue.GetQueueResponse.stats:type_name -> queue.Stats
	13, // 8: queue.GetQueuesResponse.queues:type_name -> queue.GetQueueResponse
	32, // 9: queue.EnqueueRequest.metadata:type_name -> queue.EnqueueRequest.MetadataEntry
	33, // 10: queue.EnqueueResponse.metadata:type_name -> queue.EnqueueResponse.MetadataEntry
	34, // 11: queue.DequeueResponse.metadata:type_name -> queue.DequeueResponse.MetadataEntry
	35, // 12: queue.GetResponse.metadata:type_name -> queue.GetResponse.MetadataEntry
	36, // 13: queue.NackRequest.metadata:type_name -> queue.NackRequest.MetadataEntry
	7,  // 14: queue.RaftCommand.createQueue:type_name -> queue.CreateQueueRequest
	9,  // 15: queue.RaftCommand.deleteQueue:type_name -> queue.DeleteQueueRequest
	11, // 16: queue.RaftCommand.getQueue:type_name -> queue.GetQueueRequest
	14, // 17: queue.RaftCommand.getQueues:type_name -> queue.GetQueuesRequest
	16, // 18: queue.RaftCommand.enqueue:type_name -> queue.EnqueueRequest
	18, // 19: queue.RaftCommand.dequeue:type_name -> queue.DequeueRequest
	20, // 20: queue.RaftCommand.get:type_name -> queue.GetRequest
	22, // 21: queue.RaftCommand.delete:type_name -> queue.DeleteRequest
	24, // 22: queue.RaftCommand.ack:type_name -> queue.AckRequest
	26, // 23: queue.RaftCommand.nack:type_name -> queue.NackRequest
	28, // 24: queue.RaftCommand.updatePriority:type_name -> queue.UpdatePriorityRequest
	1,  // 25: queue.DOQ.GenerateIDs:input_type -> queue.GenerateIDsRequest
	7,  // 26: queue.DOQ.CreateQueue:input_type -> queue.CreateQueueRequest
	9,  // 27: queue.DOQ.DeleteQueue:input_type -> queue.DeleteQueueRequest
	11, // 28: queue.DOQ.GetQueue:input_type -> queue.GetQueueRequest
	14, // 29: queue.DOQ.GetQueues:input_type -> queue.GetQueuesRequest
	16, // 30: queue.DOQ.Enqueue:input_type -> queue.EnqueueRequest
	16, // 31: queue.DOQ.EnqueueStream:input_type -> queue.EnqueueRequest
	18, // 32: queue.DOQ.Dequeue:input_type -> queue.DequeueRequest
	18, // 33: queue.DOQ.DequeueStream:input_type -> queue.DequeueRequest
	20, // 34: queue.DOQ.Get:input_type -> queue.GetRequest
	22, // 35: queue.DOQ.Delete:input_type -> queue.DeleteRequest
	24, // 36: queue.DOQ.Ack:input_type -> queue.AckRequest
	26, // 37: queue.DOQ.Nack:input_type -> queue.NackRequest
	28, // 38: queue.DOQ.UpdatePriority:input_type -> queue.UpdatePriorityRequest
	2,  // 39: queue.DOQ.GenerateIDs:output_type -> queue.GenerateIDsResponse
	8,  // 40: queue.DOQ.CreateQueue:output_type -> queue.CreateQueueResponse
	10, // 41: queue.DOQ.DeleteQueue:output_type -> queue.DeleteQueueResponse
	13, // 42: queue.DOQ.GetQueue:output_type -> queue.GetQueueResponse
	15, // 43: queue.DOQ.GetQueues:output_type -> queue.GetQueuesResponse
	17, // 44: queue.DOQ.Enqueue:output_type -> queue.EnqueueResponse
	17, // 45: queue.DOQ.EnqueueStream:output_type -> queue.EnqueueResponse
	19, // 46: queue.DOQ.Dequeue:output_type -> queue.DequeueResponse
	19, // 47: queue.DOQ.DequeueStream:output_type -> queue.DequeueResponse
	21, // 48: queue.DOQ.Get:output_type -> queue.GetResponse
	23, // 49: queue.DOQ.Delete:output_type -> queue.DeleteResponse
	25, // 50: queue.DOQ.Ack:output_type -> queue.AckResponse
	27, // 51: queue.DOQ.Nack:output_type -> queue.NackResponse
	29, // 52: queue.DOQ.UpdatePriority:output_type -> queue.UpdatePriorityResponse
...
func file_pkg_proto_doq_proto_init() {
	...
	file_pkg_proto_doq_proto_msgTypes[5].OneofWrappers = []any{
		(*SnapshotItem_Queue)(nil),
		(*SnapshotItem_Message)(nil),
	}
	file_pkg_proto_doq_proto_msgTypes[29].OneofWrappers = []any{
